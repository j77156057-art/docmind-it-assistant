...
def create_admin_app(settings: AppSettings | None = None,
    ...
    database = QueryDatabase(
        ...
        credential_key=config.provider_credential_key.get_secret_value() or config.auth_subject_salt.get_secret_value(),
        legacy_credential_key=config.auth_subject_salt.get_secret_value(),
    ...
    authenticator = OIDCAuthenticator(
        ...
        session_secret=config.auth_session_secret.get_secret_value(),
